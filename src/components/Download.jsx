  ...
  return (
    <div className=' relative flex flex-col justify-center py-[20px] '>
        <div className='relative md:flex hidden justify-end items-center bottom-[]  h-[400px] w-full z-10'>
            ...
            <button onClick={()=>clickDown()} className='absolute top-[72px] right-[114px] w-[62px] h-[62px] flex items-center justify-center rounded bg-white shadow-md shadow-black '>
