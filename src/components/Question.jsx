...
const Question = ({question,answer}) => {
  ...
  return (
    <div className={`w-full sm:px-[50px] px-[20px] sm:py-[35px] py-[18px] font-poppins ${extended ? 'bg-white dark:bg-secondary_dark' : 'bg-faded_text dark:bg-black_text '} flex flex-col gap-[30px] justify-center  items-start shadow-lg shadow-gray-100 dark:shadow-gray-800 rounded-[10px]` } >
      <button className='flex gap-[30px] justify-start items-center cursor-pointer w-full' onClick={() => setExtended(!extended)}> 
